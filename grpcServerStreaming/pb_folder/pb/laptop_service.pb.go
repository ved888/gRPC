...
var file_laptop_service_proto_goTypes = []interface{}{
	(*CreateLaptopRequest)(nil),  // 0: pb_folder.CreateLaptopRequest
	(*CreateLaptopResponse)(nil), // 1: pb_folder.CreateLaptopResponse
	(*SearchLaptopRequest)(nil),  // 2: pb_folder.SearchLaptopRequest
	(*SearchLaptopResponse)(nil), // 3: pb_folder.SearchLaptopResponse
	(*Laptop)(nil),               // 4: pb_folder.Laptop
	(*Filter)(nil),               // 5: pb_folder.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: pb_folder.CreateLaptopRequest.laptop:type_name -> pb_folder.Laptop
	5, // 1: pb_folder.SearchLaptopRequest.filter:type_name -> pb_folder.Filter
	4, // 2: pb_folder.SearchLaptopResponse.laptop:type_name -> pb_folder.Laptop
	0, // 3: pb_folder.LaptopService.CreateLaptop:input_type -> pb_folder.CreateLaptopRequest
	2, // 4: pb_folder.LaptopService.SearchLaptop:input_type -> pb_folder.SearchLaptopRequest
	1, // 5: pb_folder.LaptopService.CreateLaptop:output_type -> pb_folder.CreateLaptopResponse
	3, // 6: pb_folder.LaptopService.SearchLaptop:output_type -> pb_folder.SearchLaptopResponse
