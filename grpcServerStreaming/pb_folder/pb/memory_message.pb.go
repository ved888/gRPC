...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=pb_folder.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: pb_folder.Memory.Unit
	(*Memory)(nil),   // 1: pb_folder.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: pb_folder.Memory.unit:type_name -> pb_folder.Memory.Unit
