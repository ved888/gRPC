...
func TestClientCreateLaptop(t *testing.T) {
	...
	serverAddress := startTestingLaptopServer(t, laptopStore, nil, nil)
...
func TestClientUploadImage(t *testing.T) {
	...
	serverAddress := startTestingLaptopServer(t, laptopStore, imageStore, nil)
	laptopClient := newTestLaptopClient(t, serverAddress)
...
func TestClientRateLaptop(t *testing.T) {
	...
	serverAddress := startTestingLaptopServer(t, laptopStore, nil, ratingStore)
	laptopClient := newTestLaptopClient(t, serverAddress)
	...
	for i := 0; i < n; i++ {
		...
		scoreFlo := scores[i]
		score := strconv.FormatFloat(scoreFlo, 'f', -1, 64)
...
func startTestingLaptopServer(t *testing.T, laptopStore service.LaptopStore, imageStore service.ImageStore, ratingStore service.RatingStore) string {
