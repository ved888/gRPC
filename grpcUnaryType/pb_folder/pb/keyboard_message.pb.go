...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=pb_folder.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: pb_folder.Keyboard.Layout
	(*Keyboard)(nil),     // 1: pb_folder.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: pb_folder.Keyboard.layout:type_name -> pb_folder.Keyboard.Layout
