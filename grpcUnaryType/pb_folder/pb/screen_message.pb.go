...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=pb_folder.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: pb_folder.Screen.Panel
	(*Screen)(nil),            // 1: pb_folder.Screen
	(*Screen_Resolution)(nil), // 2: pb_folder.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: pb_folder.Screen.resolution:type_name -> pb_folder.Screen.Resolution
	0, // 1: pb_folder.Screen.panel:type_name -> pb_folder.Screen.Panel
