...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=pb_folder.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: pb_folder.Storage.Driver
	(*Storage)(nil),     // 1: pb_folder.Storage
	(*Memory)(nil),      // 2: pb_folder.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: pb_folder.Storage.driver:type_name -> pb_folder.Storage.Driver
	2, // 1: pb_folder.Storage.memory:type_name -> pb_folder.Memory
